...
class Menu():
    ...
    # The number 50 is the size of the actual cursor.
    ...
    # this function is used to toggle the cursor between two options
    ...
    # this function is used to toggle the cursor between unlimited options, assuming that they all have an equal distance from one another
    # the xAdjustment and yAdjustment are the distance of each element from one another, and these tell the cursor where to go
    ...
    # draws the basic stats of the player. Will show ailments if applicable.
    def draw_info(self):
    ...
    # create a deepcopy of an enemy to ensure that the original object is not altered
